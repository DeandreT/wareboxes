...
pub fn app(state: AppState) -> Router {
    let api = Router::new()
        ...
        .route(
            "/items/inventory-owners",
            get(items::list_inventory_owner_items),
        )
        .route(
            "/items/inventory-owners/add",
            post(items::add_inventory_owner_item),
        )
        .route(
            "/items/inventory-owners/delete",
            post(items::deactivate_inventory_owner_item),
        )
