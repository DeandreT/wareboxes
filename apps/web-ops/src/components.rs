...
use lucide_leptos::{
    ArrowLeft, ArrowRightLeft, Boxes, Building2, ClipboardList, LayoutDashboard, LockKeyhole,
    LockKeyholeOpen, LogOut, PackageOpen, Plus, Printer, RefreshCw, ScanBarcode, Search,
    ShieldCheck, Trash2, TriangleAlert, Truck,
};
