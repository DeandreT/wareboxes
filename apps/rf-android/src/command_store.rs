...
impl CommandOperation {
    const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::CrossDockConfirmation => "cross_dock_confirmation",
    ...
    fn parse(value: &str) -> Result<Self, CommandStoreError> {
        match value {
            ...
            "cross_dock_confirmation" => Ok(Self::CrossDockConfirmation),
...
impl From<&RfCommand> for CommandOperation {
    fn from(command: &RfCommand) -> Self {
        match command {
            ...
            RfCommand::Picking(
                PickingCommand::ClaimNext
                | PickingCommand::ClaimCluster { .. }
                | PickingCommand::ClaimZone { .. },
            ) => Self::ClaimNext,
            ...
            RfCommand::CrossDock(command) => cross_dock::command_operation(command),
