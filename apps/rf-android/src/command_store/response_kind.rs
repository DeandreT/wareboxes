...
pub(super) const fn name(kind: ResponseKind) -> &'static str {
    match kind {
        ...
        ResponseKind::CrossDockOptionalClaim => "cross_dock_optional_claim",
        ResponseKind::CrossDockClaim => "cross_dock_claim",
        ResponseKind::CrossDockConfirmation => "cross_dock_confirmation",
        ResponseKind::CrossDockRelease => "cross_dock_release",
...
pub(super) fn parse(value: &str) -> Result<ResponseKind, CommandStoreError> {
    match value {
        ...
        "cross_dock_optional_claim" => Ok(ResponseKind::CrossDockOptionalClaim),
        "cross_dock_claim" => Ok(ResponseKind::CrossDockClaim),
        "cross_dock_confirmation" => Ok(ResponseKind::CrossDockConfirmation),
        "cross_dock_release" => Ok(ResponseKind::CrossDockRelease),
